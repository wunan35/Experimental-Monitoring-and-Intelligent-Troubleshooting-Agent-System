 ...
 * 聊天服务
 *
 * <p>封装 ReactAgent 对话的公共逻辑，包括模型创建、系统提示词构建、Agent 配置等。</p>
 *
 * <h2>核心职责</h2>
 * <ul>
 *   <li>创建和配置 DashScope 大模型实例</li>
 *   <li>构建系统提示词，支持历史消息注入</li>
 *   <li>创建 ReactAgent 实例，配置工具集</li>
 *   <li>执行对话并返回结果</li>
 * </ul>
 *
 * <h2>工具集成</h2>
 * <p>Agent 可调用以下工具获取实时数据：</p>
 * <ul>
 *   <li>{@link DateTimeTools} - 获取当前时间</li>
 *   <li>{@link InternalDocsTools} - 查询内部知识库文档</li>
 *   <li>{@link QueryMetricsTools} - 查询实验告警数据</li>
 *   <li>{@link QueryLogsTools} - 查询实验日志（Mock模式）</li>
 * </ul>
 *
 * <h2>使用示例</h2>
 * <pre>{@code
 ...
 *
 * // 创建并执行 Agent
 * ReactAgent agent = chatService.createReactAgent(model, prompt);
 * String answer = chatService.executeChat(agent, question);
 * }</pre>
 *
...
public class ChatService {
    ...
    public String buildSystemPrompt(List<Map<String, String>> history) {
        ...
        // 从 PromptService 获取基础系统提示（支持版本管理）
    ...
    /**
     * 动态构建方法工具数组
     * 根据 experiment.logs.mock-enabled 决定是否包含 QueryLogsTools
     */
